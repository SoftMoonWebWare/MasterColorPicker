...
BeezEye Color Picker™
    Classic color-wheel shows HSL, HSV/HSB, HCG, LCh, OKHSL, OKHSV, OKLCh, and CMYK color-spaces (one at a time) with user-controlled Lightness/Brightness/Gray/Black.
